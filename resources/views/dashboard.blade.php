...
<body>
    ...
    <div class="content">
        ...
        <!-- Modal Konfirmasi Hapus Produk (Pindah ke luar Loop) -->
        @foreach ($products as $product)
                ...
                <div class="modal-content text-center">
                    <div class="modal-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <!-- Pesan Berhasil -->
                            <h5 class="modal-title" id="orderSuccessModalLabel" style="color: black;">Pesanan Berhasil Dibuat!</h5>
                            <p style="color: black;">Terima kasih telah memesan. Kami akan segera memproses pesanan Anda, mohon periksa WhatsApp anda</p>
                        </div>
                    </div>
                    <div class="modal-footer">
                ...
                <div class="modal-content text-center">
                    <div class="modal-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <!-- Pesan Berhasil -->
                            <h5 class="modal-title" id="orderSuccessModalLabel" style="color: black;">Barang Berhasil Terupdate</h5>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal">Tutup</button>
                ...
                <div class="modal-content text-center">
                    <div class="modal-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <!-- Pesan Berhasil -->
                            <h5 class="modal-title-add" id="orderSuccessModalLabel" style="color: black;">Barang Berhasil Ditambahkan</h5>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal">Tutup</button>
        ...
        <div class="modal fade" id="HapusBarang" tabindex="-1" aria-labelledby="orderSuccessModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content text-center">
                    <div class="modal-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <!-- Pesan Berhasil -->
                            <h5 class="modal-title" id="orderSuccessModalLabel" style="color: black;">Barang Berhasil Dihapus</h5>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal">Tutup</button>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Tampilkan modal ketika halaman dimuat
                var successModal = new bootstrap.Modal(document.getElementById('HapusBarang'));
                successModal.show();
            });
        </script>
        @endif
